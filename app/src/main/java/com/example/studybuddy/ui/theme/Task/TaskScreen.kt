...
import com.example.studybuddy.ui.theme.components.TaskCheckBox
import com.example.studybuddy.ui.theme.components.TaskDatePicker
...
data class TaskScreenNavArgs(
    val taskId: Int?,   //two arguments because  the task  screen can be called from two screens
    val subjectId: Int?, // i.e the task card from dashboard and the add task button in subject screen
)
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = state.relatedToSubject ?: "Chosen Subject",
                    style = MaterialTheme.typography.bodyLarge
                )
